...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 w-full z-10 bg-[#F9FAFB] dark:bg-[#10162F] shadow">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
        ...
        <div className="flex items-center">
          <button
            ...
            className="bg-[#10162F] dark:bg-[#FFD300] text-white dark:text-[#10162F] px-3 py-2 rounded-md transition-colors duration-300 hover:bg-[#3B82F6] dark:hover:bg-[#FFD300] flex items-center"
          >
            {darkMode ? (
              // Sun Icon
