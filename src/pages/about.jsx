...
const About = () => {
  return (
    <div className="p-6 mt-24 bg-[#F9FAFB] dark:bg-[#10162F] text-[#10162F] dark:text-[#FFFFFF] flex flex-col items-center">
      <h1 className="text-3xl font-bold mb-8 text-[#10162F] dark:text-[#FFD300]">
        About Me 🙋🏻‍♀️
      </h1>
      ...
      <img
        ...
        className="w-48 h-48 rounded-full shadow-lg mb-6 object-cover transition-transform duration-300 hover:scale-105"
      />
      ...
      <div className="max-w-3xl text-center mb-6">
        ...
        <p className="text-lg text-[#4A5568] dark:text-[#9FA2AC] mb-4">
          I am a versatile professional transitioning into full-stack development with a strong focus on front-end technologies. My background in digital learning, SaaS, and social innovation gives me a unique perspective in creating user-centered, impactful digital experiences.
        </p>
        <p className="text-lg text-[#4A5568] dark:text-[#9FA2AC] mb-4">
      ...
      <a
        ...
        download
        className="px-6 py-3 bg-[#10162F] dark:bg-[#FFD300] text-white dark:text-[#10162F] rounded-md font-semibold hover:bg-[#3B82F6] dark:hover:bg-[#FFD300] transition-colors duration-300 ease-in-out shadow-md"
      >
        Download Resume
      </a>
    </div>
