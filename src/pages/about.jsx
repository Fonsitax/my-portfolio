...
const About = () => {
  return (
    <div className="p-6 bg-[#F9FAFB] dark:bg-[var(--darkmode-color)] text-[#10162F] dark:text-[#FFFFFF] flex flex-col items-center about-section-fadeinandout">
      ...
      <div className="max-w-3xl text-center mb-6">
        <p className="text-lg text-[##10162F] dark:text-[#9FA2AC] mb-4">
          ...
          I'm passionate about creating engaging digital experiences that make a
          positive impact.
        </p>
        <p className="text-lg text-[##10162F] dark:text-[#9FA2AC] mb-4">
