...
const skills = [
  ...
  {
    name: "RESTful API",
    icon: <FaNetworkWired className="text-gray-600 dark:text-white" />,
  },
  ...
  {
    name: "MacOS",
    icon: <FaApple className="text-gray-800 dark:text-white" />,
  },
];

const SkillsHero = () => {
  return (
    <div className="mt-16 min-h-screen bg-[#F9FAFB] dark:bg-[var(--darkmode-color)] p-6 md:p-12 flex flex-col items-center">
